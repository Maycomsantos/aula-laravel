...
<?php elseif(is_array($item) && !isset($item['header'])): ?>
  <li <?php if(isset($item['id'])): ?> id="<?php echo e($item['id']); ?>" <?php endif; ?> class="nav-item <?php echo e($item['top_nav_class']); ?>">
      ...
      <?php if(isset($item['submenu'])): ?>
          <ul class="dropdown-menu border-0 shadow">
              <?php echo $__env->renderEach('adminlte::partials.menuitems.menu-item-sub-top-nav', $item['submenu'], 'item'); ?>
          </ul>
      <?php endif; ?>
  </li>
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\Aula\resources\views/vendor/adminlte/partials/menuitems/menu-item-top-nav.blade.php ENDPATH**/ ?>